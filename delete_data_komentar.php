...
if(mysqli_num_rows($cek) > 0)
{
	...
	{
		echo '<script>alert("Gagal menghapus data.php"); document.location="data_komentar.php";</script>';
	}
}
	else
	{
	echo '<script>alert("id tidak ditemukan di database."); document.location="data_komentar.php";</script>';
	}
	?>