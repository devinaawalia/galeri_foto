		  ...
		  ?>
			<form action="update_album.php" method="post">
			  <div class="form-group has-feedbck">
				...
				<input type="text" name="AlbumID" class="form-control" placeholder="AlbumID" value="<?php echo $data['AlbumID']?>">
			  ...
			  <div class="form-group has-feedback" hidden>
				...
				<input type="date" name="TanggalDibuat" class="form-control" placeholder="TanggalDibuat" value="<?php echo $data['TanggalDibuat']?>" required readonly>
				<span class="glyphicon glyphicon-lock from-control-feedbck"></span>
			  </div>
			  <div class="form-group has-feedback">
				<label>User ID :</label>
